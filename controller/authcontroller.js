...
// Default image fallback only if uploaded file is not an image
const isImage = mimetype.startsWith("image/");
const uploadedUrl = fileUploadResult.secure_url;
const fallbackImage = "https://res.cloudinary.com/damufjozr/image/upload/v1703326116/imgbin_computer-icons-avatar-user-login-png_t9t5b9.png";
  ...
  posterimg: isImage ? uploadedUrl : fallbackImage,
  posterfile: !isImage ? uploadedUrl : null // Save PDF/document URL separately
});
